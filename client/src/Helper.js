...
let userOutput = [];
preferences.checkboxes.forEach(feature => { // forEAch is iterating through the array of checkboxes on your state object
featureName = feature.name // assigns the name of each feature/preference
if (feature.checked === true) {
destinations.forEach(destinationItem => { // iterates through array of destination objects
...
console.log("Number of destinations in finalDestinations: ", finalDestinations.length)
